...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Work\UMSATS\TSAT5\corespi_test\cdh-tsat5\cdh-tsat5-libero\synthesis\cdh_tsat5_system.edn"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Work\UMSATS\TSAT5\corespi_test\cdh-tsat5\cdh-tsat5-libero\designer\cdh_tsat5_system} \
